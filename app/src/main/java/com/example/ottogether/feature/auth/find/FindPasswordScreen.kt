...
fun FindPasswordScreen(
    ...
    Scaffold(
        topBar = {
            TopAppBar(
                title = { Text("비밀번호 찾기", fontSize = 16.sp, fontWeight = FontWeight.Bold) },
                navigationIcon = {
        ...
        Column(
            ...
            Text("등록된 이메일로 임시 비밀번호를 보내드려요.", color = Color(0xFF6F7682))
            ...
            Button(
                onClick = {
                    helper = "임시 비밀번호를 전송했어요. 메일함을 확인해주세요!"
                },
                enabled = canSubmit,
                ...
                Text("임시 비밀번호 발급", fontWeight = FontWeight.Bold)
            }
        }
    }
}
